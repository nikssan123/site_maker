    ...
    >
      <DialogContent sx={{ p: 0 }}>
        ...
        <Tabs
          ...
          sx={{
            px: 3, borderBottom: '1px solid #27272a', minHeight: 44,
            '& .MuiTab-root': {
        ...
        {mode === 'library' && (
          <Box sx={{ p: 3, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Box
              sx={{
                maxHeight: 420, overflowY: 'auto', mt: 0.5,
                display: 'grid',
      ...
      {/* Suspense fallback doesn't show a spinner for every grid cell — here's a global one in case */}
      <Box sx={{ display: 'none' }}><CircularProgress /></Box>
    </Dialog>
  );
}
