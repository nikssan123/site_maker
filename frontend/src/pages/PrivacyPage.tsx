...
export default function PrivacyPage() {
  ...
  return (
    <Box component="main" sx={{ minHeight: '100dvh', bgcolor: 'background.default', py: 4 }}>
      <Seo title={t('seo.privacyTitle')} description={t('seo.privacyDesc')} path="/privacy" />
      <Container maxWidth="md">
        <Box sx={{ mb: 4, textAlign: 'center' }}><AppLogo /></Box>

        <Typography variant="h4" component="h1" fontWeight={800} mb={1}>{t('privacy.title')}</Typography>
